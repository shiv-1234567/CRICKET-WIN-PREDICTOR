...
st.title('Win Predictor for IPL Matches')

col1, col2 = st.columns(2)

with col1:
    batting_team = st.radio('Select the batting team',sorted(teams))
with col2:
    bowling_team = st.radio('Select the bowling team',sorted(teams))
